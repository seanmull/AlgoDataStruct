...
public class AnimalShelter {
	...
	public static void main(String[] args) {
		...
		//Create the data structures to maintain this 
		//system and implement operations such as enqueue, dequeueAny, dequeueDog, and dequeueCat. You may use the built-in Linked list data structure.
